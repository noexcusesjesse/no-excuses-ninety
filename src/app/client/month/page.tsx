  ...
  return (
    <>
      <div className="mb-6">
        ...
        <h1 className="mt-1 text-3xl font-semibold tracking-tight sm:text-4xl">Month</h1>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            {cycle.blockLabel}
            {" · "}
            Day {cycle.daysInCycle} of {progressOf}
            {!isRunway && cycle.monthLabel ? ` · ${cycle.monthLabel}` : ""}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-2 overflow-hidden rounded-full bg-muted">
            <div
              ...
              style={{ width: `${Math.min(100, (cycle.daysInCycle / progressOf) * 100)}%` }}
            />
          </div>
      ...
      <Card className="mb-6">
        <CardHeader><CardTitle>This month&apos;s stats</CardTitle></CardHeader>
        <CardContent>
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle>Monthly check</CardTitle>
          <CardDescription>A monthly review of logged data — not the program, and it doesn&apos;t act on its own</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              These are educational estimates, not medical prescriptions. LoadLine does not prescribe, dose, or adjust medications. Consult your physician before changing your diet.
            </p>
          </CardContent>
        </Card>
      )}
