      ...
      <main className="mx-auto max-w-2xl px-4 pb-24 pt-6 sm:px-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Start date is LoadLine 30 Day 1. Boot Camp analog is the 14 calendar days before that date. Default password is &quot;client-demo&quot; — the client should change it after first login.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <AddClientForm />
